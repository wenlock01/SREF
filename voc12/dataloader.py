...
cls_labels_dict = np.load(r"E:\E-images\weakly\Vaihingen\train\cls_labels.npy", allow_pickle=True).item()
...
class TorchvisionNormalize():
    ...
    # def __init__(self, mean=(0.485, 0.456, 0.406, 0.456), std=(0.229, 0.224, 0.225, 0.224)):
        self.mean = mean
        self.std = std
...
class VOC12ClassificationDatasetMSF(VOC12ClassificationDataset):
    ...
    def __getitem__(self, idx):
        ...
        img = imageio.imread(get_img_path(name_str, self.voc12_root))[:,:,:3]
